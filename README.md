A Rubik's cube game designed and implemented in about a weekend. Features include save slots, a score board, LAN multiplayer, and a terrible UI. Written in Unity.
